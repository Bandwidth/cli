...
func runGet(cmd *cobra.Command, args []string) error {
	...
	if err := client.Get(cmd.Context(), fmt.Sprintf("/accounts/%s/calls/%s/recordings/%s/transcription", acctID, url.PathEscape(args[0]), url.PathEscape(args[1])), &result); err != nil {
